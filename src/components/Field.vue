...
export default {
    ...
    computed: {
        classes() {
            let classes = ['w-full', 'text-right', 'px-0.5', 'lg:px-2', 'py-1', 'border', 'border-solid', 'lg:border-2', 'print:border-0', 'font-thin', 'lg:font-semibold', 'rounded-sm', 'text-xs', 'lg:text-base'];

            if (this.readonly !== undefined && this.readonly !== false) {
                classes = classes.concat(['cursor-default', 'border-gray-300', 'dark:border-gray-700', 'outline-hidden', 'dark:bg-gray-800']);
                if (this.isStatic) {
                ...
                classes = classes.concat(['shadow-inner', 'bg-white', 'dark:bg-blue-900', 'border-blue-800', 'dark:border-blue-200', 'hover:border-blue-700', 'dark:hover-border-blue-300', 'text-blue-800', 'dark:text-blue-200', 'outline-blue-600', 'dark:outline-blue-400', 'outline-offset-1']);
            }
